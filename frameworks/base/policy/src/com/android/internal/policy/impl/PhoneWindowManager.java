...
*/
	private void restoreAirplaneModeState() {
		Log.d(TAG,"restoreAirplaneModeState");
		boolean enabled_save = Settings.Global.getInt(mContext.getContentResolver(), Settings.Global.AIRPLANE_MODE_ON_FAST_BOOT,0) == 1 ? true : false;
		boolean enabled_now = Settings.Global.getInt(mContext.getContentResolver(), Settings.Global.AIRPLANE_MODE_ON,0) == 1 ? true : false;
		...
		// Post the intent
        Intent intent = new Intent(Intent.ACTION_AIRPLANE_MODE_CHANGED);
        intent.putExtra("state", enabled_save);
        mContext.sendBroadcast(intent);
	}
    ...
    private void handleLongPressOnHome() {
        ...
        Log.d(TAG, "in fun handleLongPressOnHome");
