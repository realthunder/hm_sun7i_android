...
public class NetworkTimeUpdateService {
    ...
    private static final int EVENT_WIFI_CONNECTED = 4;

    /** Normal polling frequency */
    private static final long POLLING_INTERVAL_MS = 24L * 60 * 60 * 1000; // 24 hrs
    /** Try-again polling interval, in case the network request failed */
    private static final long POLLING_INTERVAL_SHORTER_MS = 5 * 1000L; // 60 seconds
    /** Number of times to try again */
    private static final int TRY_AGAIN_TIMES_MAX = 300;
...
//Log.d(TAG, "parker------mTime.getCacheAge = " + mTime.getCacheAge());
//Log.d(TAG, "parker------POLLING_INTERVAL_MS = " + POLLING_INTERVAL_MS);
if(mTime.getCacheAge() < POLLING_INTERVAL_MS) {
