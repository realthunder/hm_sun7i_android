...
DEVICE_PACKAGE_OVERLAYS := device/softwinner/sugar-einstein/overlay

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-einstein/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/sugar-einstein/modules/modules/sun7i-ir.ko:root/sun7i-ir.ko \
	#device/softwinner/sugar-einstein/modules/modules/disp.ko:root/disp.ko \
	#device/softwinner/sugar-einstein/modules/modules/lcd.ko:root/lcd.ko \
	#device/softwinner/sugar-einstein/modules/modules/hdmi.ko:root/hdmi.ko \

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-einstein/kernel:kernel \
	device/softwinner/sugar-einstein/recovery.fstab:recovery.fstab \
	frameworks/base/data/etc/android.hardware.wifi.direct.xml:system/etc/permissions/android.hardware.wifi.direct.xml \

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-einstein/ueventd.sun7i.rc:root/ueventd.sun7i.rc \
	device/softwinner/sugar-einstein/ct-test.apk:system/app/ct-test.apk \
	device/softwinner/sugar-einstein/init.sun7i.rc:root/init.sun7i.rc \
	device/softwinner/sugar-einstein/init.sun7i.usb.rc:root/init.sun7i.usb.rc \
	device/softwinner/sugar-einstein/init/init.sda.rc:root/init.sda.rc \
	device/softwinner/sugar-einstein/init/init.sdb.rc:root/init.sdb.rc \
	device/softwinner/sugar-einstein/init/init.sdc.rc:root/init.sdc.rc \
	device/softwinner/sugar-einstein/init/init.sdd.rc:root/init.sdd.rc \
	device/softwinner/sugar-einstein/init/init.sde.rc:root/init.sde.rc \
	device/softwinner/sugar-einstein/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
	device/softwinner/sugar-einstein/needfix.rle:root/needfix.rle \
	device/softwinner/sugar-einstein/camera.cfg:system/etc/camera.cfg \
	device/softwinner/sugar-einstein/media_profiles.xml:system/etc/media_profiles.xml \
...
PRODUCT_COPY_FILES += \
	device/softwinner/sugar-einstein/initlogo.rle:root/initlogo.rle

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-einstein/vold.fstab:system/etc/vold.fstab
...
$(call inherit-product-if-exists, device/softwinner/sugar-einstein/modules/modules.mk)

PRODUCT_CHARACTERISTICS := manu

# Overrides
PRODUCT_BRAND  := cubieboard
PRODUCT_NAME   := sugar_einstein
PRODUCT_DEVICE := sugar-einstein
